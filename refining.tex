...
\begin{tikzpicture}[node distance=3cm,
  ...
  \node (temp)	 			[greenbox, left of=refining, xshift=-2cm, yshift=-1cm] {Temperature};
  \node (fission) 			[redbox, right of=refining, xshift=2cm, yshift=-1cm] {Fission Products};
  \node (pressure)			[greenbox, left of=refining, xshift=-2cm, yshift=0.5cm] {Pressure};
  \node (rotation)	 		[greenbox, left of=refining, xshift=-2cm, yshift=-2.5cm] {Rotation/Stirrer speed};
  \node (material)			[greenbox, left of=refining, xshift=-2cm, yshift=2cm] {Material};
